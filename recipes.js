...
const RECIPES = [
  ...
  },
  {
    ...
    blurb:
      "A large-batch baked mac and cheese with a three-cheese sauce and a golden broiled top.",
    ingredients: [
      "1 lb elbow pasta",
      "2 tbsp butter (for the pasta)",
      "5 tbsp butter (for the roux)",
      "2 1/2 tbsp all-purpose flour",
      "3 1/2 cups half and half",
      "1/2 cup heavy cream",
      "2 bags (16 oz each) Colby jack, shredded",
      "2 bags (16 oz each) mozzarella, shredded",
      "2 bags (16 oz each) mild cheddar, shredded",
      "Salt and black pepper, to taste",
    ],
    steps: [
      "Cook the elbow pasta in salted boiling water until al dente, then drain and toss with 2 tbsp butter to keep it from sticking.",
      "In a separate large pot, melt the remaining 5 tbsp butter over medium heat, then whisk in the flour to form a roux. Cook for a minute, stirring constantly.",
      "Pour in the half and half and heavy cream, and let simmer in the same pot until it starts to thicken.",
      "Reduce the heat to low and mix in the Colby jack, mozzarella, and mild cheddar one bag at a time, stirring constantly so the sauce stays smooth.",
      "Season the cheese sauce with salt and pepper, then fold in the cooked pasta until fully coated.",
      "Transfer to a large baking dish, top with a little extra shredded cheese, and bake at 350°F (175°C) for about 20 minutes, until bubbly and golden on top.",
    ],
  },
  {
    id: 9,
    ...
    blurb:
      "A simple yeasted pizza dough with garlic, oregano, and basil baked right into the crust.",
    ingredients: [
    ...
    steps: [
      "Dissolve the sugar in the warm water, then sprinkle the yeast on top. Let sit until foamy, about 5 to 10 minutes.",
      "In a large bowl, whisk together the bread flour, salt, oregano, basil, and garlic powder.",
      "Make a well in the center and pour in the yeast mixture and 2 tbsp of the olive oil.",
      "Stir until a shaggy dough forms, then turn out onto a floured surface and knead until smooth and elastic, about 8 minutes, adding more flour as needed.",
      "Shape into a ball, rub with the remaining tablespoon of olive oil, and place in a bowl covered with plastic wrap. Let rise in a warm spot until doubled, about 1 hour.",
      "Punch down the dough, stretch or roll it out into a round, and top as desired.",
      "Bake on a preheated pizza stone or baking sheet at 475°F (245°C) for 12 to 15 minutes, until the crust is golden.",
    ],
  },
  {
    id: 10,
